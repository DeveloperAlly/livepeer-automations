...
Use your existing repository (e.g., `livepeer-automations`) or create a new one.
...
Your announcements will be available at:
`https://[USERNAME].github.io/[REPO-NAME]/discord/announcements/`

Example: `https://developerally.github.io/livepeer-automations/discord/announcements/`
...
<body>
    ...
    <script>
        ...
        async function loadAnnouncements() {
            try {
                // Use relative path to load the JSON file from the same directory
...
- **Repository Name:** your-repo-name (e.g., livepeer-automations)
...
GET: https://api.github.com/repos/{owner}/{repo}/contents/discord/announcements/announcements.json

// Update file
PUT: https://api.github.com/repos/{owner}/{repo}/contents/discord/announcements/announcements.json
Headers: 
...
<iframe 
  src="https://YOUR-USERNAME.github.io/YOUR-REPO/discord/announcements/"
  width="100%"
  height="600"
  style={{
...
<iframe 
  src="https://developerally.github.io/livepeer-automations/discord/announcements/"
  width="100%"
  height="600"
  style={{
    border: "1px solid #e2e8f0",
...
```mdx
<iframe 
  src="https://YOUR-USERNAME.github.io/YOUR-REPO/discord/announcements/index.html?limit=5"
  width="100%"
  height="400"
...
<Frame caption="Latest Discord Announcements">
  <div 
    dangerouslySetInnerHTML={{
      __html: '<iframe src="https://YOUR-USERNAME.github.io/YOUR-REPO/discord/announcements/" width="100%" height="500" style="border:none;" />'
    }} 
  />
</Frame>
```
...
1. Visit: `https://YOUR-USERNAME.github.io/YOUR-REPO/discord/announcements/`
   Example: `https://developerally.github.io/livepeer-automations/discord/announcements/`
2. Check browser console for errors
3. Verify announcements.json loads correctly from same directory
...
- When using subdirectories, ensure relative paths in your HTML/JS
- If issues persist, consider using raw.githubusercontent.com

**Subdirectory Considerations:**
- All file paths in n8n must include the full path: `discord/announcements/[filename]`
- Use relative paths (`./announcements.json`) in your HTML/JavaScript
- The iframe src in Mintlify must use the complete URL with subdirectory
...
- [ ] Create directory structure: `/discord/announcements/` in your repo
- [ ] Verify GitHub Pages is enabled for your repository
- [ ] Create GitHub personal access token
- [ ] Upload index.html to `/discord/announcements/`
- [ ] Upload announcements.json to `/discord/announcements/`
- [ ] Import n8n workflow
- [ ] Configure Discord credentials in n8n
- [ ] Update file paths in n8n to include subdirectory
- [ ] Test workflow execution
- [ ] Add iframe to Mintlify docs with full path
